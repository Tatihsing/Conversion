...
:: exit code 2 = update downloaded, bat will apply it
...
:: xcopy to overwrite files safely
echo [1/3] 套用新版程式...
...
:: update start.bat last (currently running, new version takes effect on next launch)
